...
import image1 from '../../assets/images/cardslider/radio1.jfif';
import image2 from '../../assets/images/cardslider/radio2.jfif';
import image3 from '../../assets/images/cardslider/radio3.jfif';
import image4 from '../../assets/images/cardslider/radio4.jfif';
...
const CardPopupSlider = () => {
  const sliderRef = useRef(null);
  const cards = [
    { image: image1, name: 'Mathew' },
    { image: image2, name: 'John' },
    { image: image3, name: 'Sarah' },
    { image: image4, name: 'Anna' },
  ];
  const totalSlots = 7;
...
export default CardPopupSlider;
